...
class SingleplayerScreen(PlayScreen):
    ...
    Description:
    This class manages the singleplayer mode of the SET game.
    It handles player and computer scores, computer timing,
    input handling, and singleplayer-specific game flow.

    Parameters:
    game:
        The main Game object used to access shared game state,
        table logic, timers, sounds, and screen transitions.

    Structure:
        - Inherits from PlayScreen
        - Stores player and computer scores
        - Manages computer thinking and clicking timing
        - Handles singleplayer input and winner checking
        - Draws the singleplayer interface

    Output:
        Updates and displays the full singleplayer gameplay state.
    """
    def __init__(self, game):  # self.game_screen = GameScreen(self)
        """Initialize singleplayer scores, difficulty, and computer timers."""
        super().__init__(game)
    ...
    def reset_game_screen(self):
        """Reset scores, computer state, and the singleplayer game screen."""
    ...
    def clear_set_timer(self):
        """Clear the answer timer and restart the computer timer."""
        super().clear_set_timer()
        self.reset_computer_timer()

    def resume_game_timer(self):
        """Resume the game timer and shift the computer timer after pause."""
        if self.paused:
    ...
    def check_game_timeout(self):
        """Check whether game time ended and move to the winner screen."""
    ...
    def check_winner(self):
        """Check whether no sets remain and decide the final winner."""
    ...
    def reset_computer_timer(self):
        """Set a new target time for the computer's next move."""
    ...
    def update_computer(self):
        ...
        Function:
        Decides when the computer should start a turn, select cards,
        make a correct or incorrect set attempt based on difficulty,
        update the score, and finish its move.
        """
    ...
    def handle_event(self, event):
        """Handle player input, buttons, and card actions in singleplayer mode."""
    ...
    def draw(self, screen):
        """Draw the singleplayer interface, scores, timers, buttons, and messages."""
